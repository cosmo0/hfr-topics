...
Comme la Wii, la DS est une console parfaite pour initier les "non-joueurs" : écran tactile et jeux adaptés au grand public, tout est là.
...
- Les jeux longs sont à éviter, si il faut s'investir et passer des dixaines d'heures pour en venir à bout (coucou les RPG), il y a de grandes chances que le jeu soit abandonné en cours de route. A proscrire : les RPG (encore).
- Les jeux violents sont rarement appréciés, que ce soit plein d'hémoglobine ou très soft, un jeu à base de combats attire rarement. Evidemment, si c'est juste du sautage sur des champignons, ça passe. Si il faut massacrer humanoïdes et monstres à la chaîne, ça attire moins. A proscrire : les RPG (encore...), les jeux d'action en général (combat, shoot, FPS...), les jeux de plate-forme type Castlevania ou Megaman.

Voici une petite liste concoctée par moi-même et d'autres forumeurs, avec quelques précisions pour justifier les choix.

- Entrainement Cérébral, Cérébrale Académie : quelques jeux ludo-éducatif pour rentrer dans le bain et donner envie de voir un peu plus ce que la console a dans le ventre. Si la personne est réfractaire à cette étape, inutile d'aller plus loin à mon avis.
...
- Nintendogs, Animal Crossing : des jeux mignons, sans réel but ni obstacle donc faciles, qui touchent facilement la sensibilité des jeunes filles ; ça cartonne avec ma fille à 4 ans par exemple.
- Oendan, Elite Beat Agent, Trauma Center, 42 jeux indémodables, Metroid Prime Pinball : des jeux très intuitif à prendre en main, certes parfois relativement durs mais ça n'a pas l'air d'arrêter grand-monde. Attention, Trauma Center, c'est vraiment difficile, mais le principe accroche très bien.
- New Super Mario Bros, Kirby Le Pinceau de Pouvoir, Kirby les Souris Attaquent, Super Princess Peach : des jeux de plate-forme accessibles, mignons, pas compliqués, pas violent (je l'ai déjà dit, les champignons ça compte pas), bref, du tout bon.

Ensuite, c'est à vous de voir : cette personne aime-t-elle particulièrement un type de jeu ? Plates-formes, course, jeu de rôle, sport, aventure... Faites-lui tester vos jeux, si elle aime le genre mais que le jeu est trop dur ou trop compliqué, essayez d'en trouver un simplifié : Pokémon est bien plus simple à appréhender que Shin Megami Tensei.  
Certains jeux que vous trouvez trop basiques peuvent très bien passer : n'ayant pas le même passé vidéoludique, les exigences sont très différentes.  
Essayez aussi de changer d'univers : heroic fantasy (Final Fantasy), science fiction (Infinite Space), moderne (The World Ends With You), à mascotte (Mario & Luigi), mignon (Pokémon), fantastique (Shin Megami Tensei), etc.

## Si les jeux DS ne vous suffisent pas : les jeux GBA

Si dans la liste des jeux ci-dessus ne vous suffit pas, n'oubliez pas que la DS et la DS Lite sont compatibles avec [les jeux GBA](https://www.cosmo0.fr/les-meilleurs-jeux/les-meilleurs-jeux-gba/) (mais pas la DSi).
